...
export default function TransparentHeader() {
  ...
  return (
    <>
      ...
      <header className={`bg-transparent fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out ${
          ...
          <div className="flex items-center min-w-0 flex-1">
            <Link href="/" className="hover:opacity-80 transition-opacity">
              <div className="logo-container">
                <Image 
                  src="/ReliefGuard_logo_white.png" 
                  alt="ReliefGuard" 
                  width={320} 
                  height={80} 
          ...
          <div className="flex items-center space-x-0 sm:space-x-1">
            ...
            {loading ? (
              ...
              <div className="relative ml-3">
                <div className="flex items-center gap-2 px-4 py-2 rounded-lg border border-white/30 h-10 min-w-[120px]">
                  <div className="w-6 h-6 rounded-full bg-white/20 flex-shrink-0" />
                  <div className="hidden sm:block w-16 h-4 bg-white/20 rounded" />
              ...
              <div className="relative ml-3">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-white/10 transition-colors border border-white/30 h-10"
                >
                  ...
                  {user.displayName ? (
                    <span className="hidden sm:block text-xs sm:text-lg lg:text-xl font-medium text-white truncate max-w-40 font-montserrat leading-none">
                      {user.displayName.split(' ')[0]}
                    </span>
                  ) : (
                    <span className="hidden sm:block text-xs sm:text-sm lg:text-base font-medium text-white truncate max-w-40 font-montserrat leading-none">
                      {user.email}
                    </span>
                  )}
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-64 rounded-lg bg-white shadow-lg ring-1 ring-black/5 z-20 overflow-hidden">
                      ...
                      <div className="py-2">
                        <button
                          onClick={() => setShowUserMenu(false)}
                          className="w-full px-4 py-3 text-left text-base text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors flex items-center gap-3 font-montserrat"
                        >
                      ...
                      <button
                        ...
                        className="w-full px-4 py-3 text-left text-base font-medium text-red-600 hover:bg-red-50 transition-colors flex items-center gap-3 font-montserrat"
                      >
              ...
              <button
                ...
                className="px-1 sm:px-3 py-2 text-xs sm:text-lg lg:text-xl font-medium text-white hover:text-gray-200 transition-colors duration-200 font-montserrat navbar-text"
              >
                Login
              </button>
            )}
